 	...
 	if ( $r->have_posts() ) {
 		if($template== 'default'){
 			...
 			<div id="<?php echo $pf_id ?>" class="sw-best-seller-product vc_element">
 				...
 				if( $title != '' ){ 
 					?>
 					<div class="box-title"><h3><?php echo esc_html( $title ); ?></h3></div>
 					<?php } ?>
...
function sw_rating_shortcode($atts){
  ...
  <?php }elseif($template == 'style1'){ ?>
	 <div id="<?php echo 'latest_review_' .rand().time(); ?>" class="responsive-slider sw-latest-review2 loading <?php echo esc_attr( $el_class ); ?>" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
    <?php if( $title != '' ) : ?>
