...
?>
<div class="sw-woo-tab-cat4 style7 sw-ajax" id="<?php echo esc_attr( 'category_' . $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">
		<div class="top-tab-slider clearfix">
			<div class="box-title"><?php echo ( $title1 != '' ) ? '<h3 class="font-custome"><span>'. esc_html( $title1 ) .'</span></h3>' : ''; ?></div>
