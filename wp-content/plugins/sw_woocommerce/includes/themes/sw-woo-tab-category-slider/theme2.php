									...
									<div class="item-detail">	
										...
										<?php sw_label_sales();?>
											<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
												<?php 								
													$width  = ( $img_w ) ? $img_w : 300;
													$height = ( $img_h ) ? $img_h : 400;
