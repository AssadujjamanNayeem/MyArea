			...
			vc_map( array(
			  ...
			  "params" => array(
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Color", 'sw_woocommerce' ),
					"param_name" => "color",
					"value" => '',
					"description" => __( "Select background color for heading box.", 'sw_woocommerce' ),
					"dependency" => array( 
						'layout' => array( 'childcat4' )
						)
					),
		...
		**/
		function WS_Shortcode( $atts ){
			...
			switch ( $layout ) {			
				...
				break;
				case 'default3':
					$path = sw_override_check( 'sw-slider', 'default3' );
				break;				
				case 'featured':
				...
				break;
				case 'featured5':
					$path = sw_override_check( 'sw-slider', 'featured5' );
				break;
