	...
	class sw_woo_cat_slider_widget extends WP_Widget {
			...
			vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','theme3','theme4', 'theme5','theme6','theme7','theme8','theme9','theme10' )
					),
				 ),	
				  array(
					"type" => "multiselect",
					...
					"dependency" => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','layout2','layout3','theme3','theme4','theme5','theme6','theme7','theme8','theme9','theme10' )
					),
				 ),
				   array(
					"type" => "dropdown",
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default', 'theme1','theme2','layout2','theme3','theme4','theme6','theme8','theme9','theme10' )
					),
				 ),
				 array(
					"type" => "dropdown",
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Theme1' => 'theme1', 'Layout Theme2' => 'theme2', 'Layout Theme3' => 'theme3', 'Layout Theme4' => 'theme5', 'Layout Theme5' => 'theme6', 'Layout Theme6' => 'theme7', 'Layout Theme7' => 'theme8', 'Layout Theme8' => 'theme9', 'Layout Theme9' => 'theme10', 'Layout Category Ajax' => 'layout2', 'Layout Mobile' => 'layout3',  'Layout Mobile2' => 'theme4', 'Layout Mobile Ajax' => 'layout4' ),
				 ...
				 array(
				  ...
				  array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Image Width", 'sw_woocommerce' ),
					"param_name" => "img_w",
					"value" => 0,
					"description" => __( "Set image width.", 'sw_woocommerce' ),
					'group' => esc_html__( 'Image Config', 'sw_woocommerce' )
				 ),
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Image Height", 'sw_woocommerce' ),
					"param_name" => "img_h",
					"value" => 0,
					"description" => __( "Set image height.", 'sw_woocommerce' ),
					'group' => esc_html__( 'Image Config', 'sw_woocommerce' )
				 ),
				  ...
				  array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Crop", 'sw_woocommerce' ),
					"param_name" => "crop",
					"value" => array( 'False' => 'false', 'True' => 'true' ),
					"description" => __( "Select crop image", 'sw_woocommerce' ),
					'group' => esc_html__( 'Image Config', 'sw_woocommerce' )
				 ),
			  )
		   ) );
		...
		**/
		function WSC_Shortcode( $atts, $content = null ){
			...
			}elseif( $layout == 'theme10' ){
				include( sw_override_check( 'category-slider', 'theme9' ) );	
			}
	...
	?>
		...
		**/
		...
		function sw_category_ajax_listing(){
			...
			$width	= ( isset( $_POST["img_w"] )  && $_POST["img_w"] != '' ) ? $_POST["img_w"] : 210;
			$height	= ( isset( $_POST["img_h"] )  && $_POST["img_h"] != '' ) ? $_POST["img_h"] : 270;
			$crop	= ( isset( $_POST["crop"] )  && $_POST["crop"] != '' ) ? $_POST["crop"] : false;
			$title_length = ( isset( $_POST["title_length"] )  	&& $_POST["title_length"] > 0 ) ? $_POST["title_length"] : 0;
