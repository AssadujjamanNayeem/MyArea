	...
	class sw_woo_tab_cat_slider_widget extends WP_Widget {
			  ...
			  "params" => array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout 1' => 'layout1', 'Layout 2'=>'layout2', 'Layout 3'=>'layout3', 'Layout 4'=>'layout4', 'Layout 5'=>'layout5', 'Layout 6'=>'layout6' ),
		...
		**/
		function SC_WooTab( $atts, $content = null ){
			...
			if( $layout == 'default' ){
				...
				include( sw_override_check( 'sw-woo-tab-category-slider', 'theme6' ) );
			}
		...
		**/
		function sw_ajax_tab_callback(){
			...
			$width		 	 = ( isset( $_POST["img_w"] )  && $_POST["img_w"] != '' ) ? $_POST["img_w"] : 300;
			$height			 = ( isset( $_POST["img_h"] )  && $_POST["img_h"] != '' ) ? $_POST["img_h"] : 400;
								...
								<div class="item-wrap">
									<div class="item-detail">	
										...
										<div class="item-img products-thumb">		
											...
											<?php 								
												$width  = ( $img_w ) ? $img_w : 600;
												$height = ( $img_h ) ? $img_h : 800;
			...
			<div id="<?php echo esc_attr( 'tab_cat_'. $target ); ?>" class="woo-tab-container-slider responsive-slider loading clearfix" data-lg="<?php echo esc_attr( $columns ); ?>" data-md="<?php echo esc_attr( $columns1 ); ?>" data-sm="<?php echo esc_attr( $columns2 ); ?>" data-xs="<?php echo esc_attr( $columns3 ); ?>" data-mobile="<?php echo esc_attr( $columns4 ); ?>" data-speed="<?php echo esc_attr( $speed ); ?>" data-scroll="<?php echo esc_attr( $scroll ); ?>" data-interval="<?php echo esc_attr( $interval ); ?>"  data-autoplay="<?php echo esc_attr( $autoplay ); ?>">
					<div class="resp-slider-container">
						...
						<?php 
							...
							if( $i % $item_row == 0 ){
						?>
							<div class="item-product <?php echo esc_attr( $class )?> product clearfix">
						<?php } ?>
							<div class="item-wrap clearfix">
								<div class="item-detail">										
									<div class="item-img pull-left">
										<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail( 'shop_thumbnail' ); ?></a>
									</div>										
									<div class="item-content">																	
										<h4><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute();?>"><?php sw_trim_words( get_the_title(), $title_length ); ?></a></h4>
										<!-- rating  -->
