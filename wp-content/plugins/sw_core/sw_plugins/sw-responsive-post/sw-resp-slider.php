			...
			vc_map( array(
				...
				'class'         => ''
				 ...
				 array(
					...
					"param_name" => "layout",
					"value" => array( 'Layout Default' => '1', 'Layout 1' => '2', 'Layout 2' => '3', 'Layout 3' => '4', 'Layout 4' =>'5', 'Layout 5' =>'6', 'Layout 6' =>'7', 'Layout 7' =>'8', 'Layout 8' =>'9' ),
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Image Width", 'sw_core' ),
					"param_name" => "img_w",
					"value" => 0,
					"description" => __( "Set image width.", 'sw_core' ),
					'group' => esc_html__( 'Image Config', 'sw_core' )
				 ),
				 ...
				 array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Image Height", 'sw_core' ),
					"param_name" => "img_h",
					"value" => 0,
					"description" => __( "Set image height.", 'sw_core' ),
					'group' => esc_html__( 'Image Config', 'sw_core' )
				 ),
				  ...
				  array(
					...
					"holder" => "div",
					"class" => "",
					"heading" => __( "Crop", 'sw_core' ),
					"param_name" => "crop",
					"value" => array( 'False' => 'false', 'True' => 'true' ),
					"description" => __( "Select crop image", 'sw_core' ),
					'group' => esc_html__( 'Image Config', 'sw_core' )
				 ),
				)
			 ) );
		...
		**/
		function RP_Shortcode( $atts, $content = null ){
			...
			if( $layout == 1 ){
				...
				include( sw_core_override_check( 'sw-responsive-post', 'layout7' ) );
			}elseif( $layout == 9 ){
				include( sw_core_override_check( 'sw-responsive-post', 'layout8' ) );
			}
			else{
