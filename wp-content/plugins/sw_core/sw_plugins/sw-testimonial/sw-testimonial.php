				...
				array(
			 	...
			 	array(
					...
					'value' => array(
						...
						__( 'Layout Them2','sw_core' ) => 'layout3',
						__( 'Layout Them3','sw_core' ) => 'layout4',
						__( 'Layout Them4','sw_core' ) => 'layout5',
					),
	...
	**/
	function TT_Shortcode( $atts,$content = null ){
		...
		if( $layout == 'default' ){
			...
			include( sw_core_override_check( 'sw-testimonial', 'layout4') );
		}elseif( $layout == 'layout5' ){
			include( sw_core_override_check( 'sw-testimonial', 'layout5') );
		}
