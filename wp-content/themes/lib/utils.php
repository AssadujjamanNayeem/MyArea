	...
	if( !revo_mobile_check() ) : 
		...
		*/
		if( $sticky_menu ) :		
				...
				elseif( $revo_header_style == 'style2' || $revo_header_style == 'style3' || $revo_header_style == 'style5' || $revo_header_style == 'style6' || $revo_header_style == 'style7' || $revo_header_style == 'style8' || $revo_header_style == 'style9' || $revo_header_style == 'style10' || $revo_header_style == 'style12' || $revo_header_style == 'style14' || $revo_header_style == 'style21' ){
					$output .= 'var sticky_navigation_offset = $("#header .header-bottom").offset();';
					$output .= 'if( typeof sticky_navigation_offset != "undefined" ) {';
					$output .= 'var sticky_navigation_offset_top = sticky_navigation_offset.top;';
					$output .= 'var sticky_navigation = function(){';
