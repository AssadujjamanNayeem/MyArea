...
<div class="top-form top-form-minicart revo-minicart3 pull-right">
	<div class="top-minicart-icon pull-right">
		...
		<div class="title-cart">
			...
			<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_html_e( 'View your shopping cart', 'revo' ); ?>"><?php echo '<span class="minicart-numbers">'.$woocommerce->cart->cart_contents_count.'</span>' . esc_html__(' item(s)', 'revo') .' : '. $woocommerce->cart->get_cart_total(); ?></a>
		</div>
	</div>
