...
<div class="container">
	...
	<!-- Left Sidebar -->
	<?php 	
	if ( is_active_sidebar('left-product') && revo_sidebar_product() != 'right' && revo_sidebar_product() != 'full' ):
	...
	<!-- Right Sidebar -->
	<?php if ( is_active_sidebar('right-product') && revo_sidebar_product() != 'left' && revo_sidebar_product() != 'full' ):
